...
export function RunShareCard({ activity, forwardRef }) {
  ...
  return (
    <View ref={forwardRef} style={s.card} collapsable={false}>
      ...
      <View style={s.segmentBox}>
        ...
        {segments.length > 3 && (
          <Text style={s.moreSegments}>+{segments.length - 3} ще...</Text>
        )}
      </View>
...
const s = StyleSheet.create({
  ...
  decor2: {
    ...
    backgroundColor: '#2196f3', opacity: 0.07,
  },
  decor3: {
  ...
  logoWrap: {
    ...
    backgroundColor: NAVY2, overflow: 'hidden',
  ...
  statsRow: {
    ...
    backgroundColor: NAVY2, borderRadius: 16, padding: 16, marginBottom: 16,
  },
  statBlock: { flex: 1, alignItems: 'center' },
  statValue: { color: WHITE, fontSize: 22, fontWeight: '900', letterSpacing: -0.5 },
  statLabel: { color: DIM, fontSize: 9, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.8, marginTop: 3 },
  statSep: { width: 1, height: 36, backgroundColor: 'rgba(255,255,255,0.1)' },
  segmentBox: {
    backgroundColor: NAVY2, borderRadius: 16, padding: 14, marginBottom: 16,
  },
